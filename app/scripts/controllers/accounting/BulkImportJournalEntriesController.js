(function (module) {
    mifosX.controllers = _.extend(module, {
        BulkImportJournalEntriesController: function (scope, http, resourceFactory, location, API_VERSION, $rootScope, Upload) {
            ...
            scope.download = function () {
                http({
                    ...
                    linkElement.setAttribute('download', 'GL_JOURNAL_ENTRIES' + today + '.xls');
    ...
    mifosX.ng.application.controller('BulkImportJournalEntriesController', ['$scope', '$http', 'ResourceFactory', '$location', 'API_VERSION', '$rootScope', 'Upload', mifosX.controllers.BulkImportJournalEntriesController]).run(function ($log) {
