(function (module) {
    mifosX.controllers = _.extend(module, {
        BulkImportFixedDepositAccountsController: function (scope, http, resourceFactory, location, API_VERSION, $rootScope, Upload) {
            ...
            scope.download = function () {
                http({
                    ...
                    linkElement.setAttribute('download', 'FIXED_DEPOSIT_ACCOUNTS' + today + '.xls');
    ...
    mifosX.ng.application.controller('BulkImportFixedDepositAccountsController', ['$scope', '$http', 'ResourceFactory', '$location', 'API_VERSION', '$rootScope', 'Upload', mifosX.controllers.BulkImportFixedDepositAccountsController]).run(function ($log) {
