(function (module) {
    mifosX.controllers = _.extend(module, {
        BulkImportRecurringDepositController: function (scope, http, resourceFactory, location, API_VERSION, $rootScope, Upload) {
            ...
            scope.download = function () {
                http({
                    ...
                    linkElement.setAttribute('download', 'RECURRING_DEPOSIT_ACCOUNTS' + today + '.xls');
    ...
    mifosX.ng.application.controller('BulkImportRecurringDepositController', ['$scope', '$http', 'ResourceFactory', '$location', 'API_VERSION', '$rootScope', 'Upload', mifosX.controllers.BulkImportRecurringDepositController]).run(function ($log) {
