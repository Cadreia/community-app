(function (module) {
    mifosX.controllers = _.extend(module, {
        BulkImportLoanRepaymentController: function (scope, http, resourceFactory, location, API_VERSION, $rootScope, Upload) {
            ...
            scope.download = function () {
                http({
                    ...
                    linkElement.setAttribute('download', 'LOAN_TRANSACTIONS' + today + '.xls');
    ...
    mifosX.ng.application.controller('BulkImportLoanRepaymentController', ['$scope', '$http', 'ResourceFactory', '$location', 'API_VERSION', '$rootScope', 'Upload', mifosX.controllers.BulkImportLoanRepaymentController]).run(function ($log) {
